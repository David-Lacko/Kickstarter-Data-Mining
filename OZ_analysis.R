...
# type conversion
{
  ...
  plot_str(kickstarterData2016_1)
  ...
  plot_str(kickstarterData2018_1)
...
# analysis №2
{
  # kickstarter2016
  {
    ...
    ggplot(kickstarterData2016_1 %>% filter(backers <= 1000), aes(x = backers)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2016")
    ggplot(kickstarterData2016_1 %>% filter(goal <= 2000), aes(x = goal)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2016")
    ggplot(kickstarterData2016_1 %>% filter(pledged <= 5000), aes(x = pledged)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2016")
  ...
  # kickstarter2018
  {
    ...
    ggplot(kickstarterData2018_1 %>% filter(backers <= 1000), aes(x = backers)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2018")
    ggplot(kickstarterData2018_1 %>% filter(goal <= 2000), aes(x = goal)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2018")
    ggplot(kickstarterData2018_1 %>% filter(pledged <= 5000), aes(x = pledged)) + geom_histogram(binwidth = 5) + ggtitle("kickstarterData2018")
...
# description task
{
  ...
  # clustering
  {
    ...
    { 
      ...
      ggplot(kickstarterData2016_des[c(-2, -8, -1, -4, -9)], aes(x=backers, y=pledged, color=state)) + geom_point()
      
      purity(kickstarterData2016_des$state, kmeans.kickstarterData2016$cluster)
      ineq(kmeans.kickstarterData2016$cluster, type="Gini")
    }
    ...
    # clustering 2018
    {
      ...
      ggplot(kickstarterData2018_des[c(-2, -8, -1, -4, -9)], aes(x=backers, y=pledged, color=state)) + geom_point()
      
      purity(kickstarterData2018_des$state, kmeans.kickstarterData2018$cluster)
      ineq(kmeans.kickstarterData2018$cluster, type="Gini")
    }
  }
}
